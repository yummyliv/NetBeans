...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk dist/V1/Debug/V1AppTemplate.exe

dist/V1/Debug/V1AppTemplate.exe: ${OBJECTFILES}
	${MKDIR} -p dist/V1/Debug
	arm-oe-linux-gnueabi-g++ -o dist/V1/Debug/V1AppTemplate ${OBJECTFILES} ${LDLIBSOPTIONS} -L . "-L${SDKV1LIB}" "-L${SDKV1LIBN}"
